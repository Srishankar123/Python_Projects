class Payroll:
    ...
    def __str__(self):
        return (
            f"Payroll ID: {self.__payroll_id}, Employee ID: {self.__employee_id}\n"
            f"Period: {self.__pay_period_start_date} to {self.__pay_period_end_date}\n"
            f"Basic Salary: ${self.__basic_salary:,.2f}, Overtime Pay: ${self.__overtime_pay:,.2f}\n"
            f"Deductions: ${self.__deductions:,.2f}, Net Salary: ${self.__net_salary:,.2f}"
        )